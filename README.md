...
위 명령어를 입력했을 때, 다음과 terminal에 다음과 같이 출력됨  
![push](https://user-images.githubusercontent.com/54675015/117538696-54162680-b042-11eb-836a-a8a094a66300.PNG)

github 사이트에 접속해서 해당 repository 카테고리를 main->master로 변경하면 다음과 같이 commit했던 파일들이 원격저장소에 업로드된 것을 볼 수 있음  
![push(github)](https://user-images.githubusercontent.com/54675015/117538706-5d06f800-b042-11eb-9c26-e2482e577f59.PNG)
...
3) git reset --hard [커밋ID] 를 입력함.  
이때 커밋ID는 $git log를 입력했을때 commit~ 이후에 나오는 일련번호의 앞6자리임. 이것을 복사해서 붙여넣으면 됨  
